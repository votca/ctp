...
OBJECTFILES= \
	...
	${OBJECTDIR}/_ext/4edd36c3/electron.o \
...
${OBJECTDIR}/_ext/4edd36c3/electron.o: nbproject/Makefile-${CND_CONF}.mk ../../src/libkmc/carriers/electron.cc 
	${MKDIR} -p ${OBJECTDIR}/_ext/4edd36c3
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../include -I../../include/votca/kmc -I../../../include/votca/tools -I../../../include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/4edd36c3/electron.o ../../src/libkmc/carriers/electron.cc
